...
public class ContactUs extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent myIntent=new Intent(ContactUs.this,AboutUs.class);
            startActivity(myIntent);
        } else if (id == R.id.nav_map) {
            Intent myIntent=new Intent(ContactUs.this,Maps.class);
            startActivity(myIntent);
        } else if (id == R.id.nav_directions) {
            Intent myIntent=new Intent(ContactUs.this,Directions.class);
            startActivity(myIntent);
        } else if (id == R.id.nav_showtimings) {
            Intent myIntent=new Intent(ContactUs.this,ShowTimings.class);
            startActivity(myIntent);
