 ...
 */
public class  directions_toll_nuclear extends AppCompatActivity {
    private static final String TAG = directions_toll_nuclear.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_directions_toll_nuclear);
