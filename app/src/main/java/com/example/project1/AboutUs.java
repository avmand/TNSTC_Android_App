...
/*
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent myIntent=new Intent(AboutUs.this,Directions.class);
            startActivity(myIntent);
        } else if (id == R.id.nav_showtimings) {
            Intent myIntent=new Intent(AboutUs.this,ShowTimings.class);
            startActivity(myIntent);
        } else if (id == R.id.nav_contactus) {
            Intent myIntent=new Intent(AboutUs.this,ContactUs.class);
            startActivity(myIntent);
        }
