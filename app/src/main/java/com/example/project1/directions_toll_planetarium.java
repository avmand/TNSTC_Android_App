 ...
 */
public class  directions_toll_planetarium extends AppCompatActivity {
    private static final String TAG = directions_toll_planetarium.class.getSimpleName();
                ...
                (HitResult hitResult, Plane plane, MotionEvent motionEvent) -> {
                    ...
                    if(flag[0] ==0) {
                        ...
                        for( i=1;i<4;i++)
                        {
                            ...
                            andy2.setRenderable(andyRenderable);
                            andy2.setLocalPosition(new Vector3(i, 0.0f,0.0f ));
                        }
                        //till planetarium
